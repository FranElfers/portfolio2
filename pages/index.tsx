...
import { BufferAttribute, BufferGeometry, CameraHelper, Color, DirectionalLight, GridHelper, PerspectiveCamera, Points, PointsMaterial, Scene, TextureLoader, WebGLRenderer } from 'three'
import { smoothOut } from './smooth_movement'
import { OrbitControls } from 'three/examples/jsm/controls/OrbitControls'

const Home: NextPage = () => {
  const [ gyroscopeSupport, setGyroscopeSupport ] = useState(false)
  const [ gyroscopeValues, setGyroscopeValues ] = useState({x:0,y:0})
  ...
  return <div className={styles.container}>
    ...
    <canvas className={styles.background} ref={backgroundRef}></canvas>
    {/* <main className={styles.main}>
      <p>{gyroscopeSupport ? 'support' : 'no support'}</p>
      <p>{gyroscopeValues.x.toFixed(1)} - {gyroscopeValues.y.toFixed(1)}</p>
    </main> */}
  </div>
}
